...
Drag and drop an image into any other empty box.
...
This is day 21 of the '50 Projects In 50 Days' Udemy course by Brad Traversy and Florin Pop.
...
- Drag and image from one box into another.
- A border is added when the image is selected.
- The background of the selected box to drop into changes colour.
